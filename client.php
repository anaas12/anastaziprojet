...
class Client {
    ...
    public function insertClient($projet2, $conn) {
        // insert a client in the database, and give a message to $successMsg and $errorMsg
        $sql = "INSERT INTO $projet2 (firstname, lastname, email, password,idCity)
    ...
    public static function deleteClient($tableName, $conn, $id) {
        // delete a client by his id, and send the user to read.php
